...
write.table(
  assay(vsd),
  "./resources/processed_data/gsea/scaled_count_vsd_2024-12-27.txt",
  sep = "\t",
  row.names = TRUE, 
  col.names = NA
)
...
unique_classes <- unique(labels)                  # e.g., c("pauci", "neut", "eos", "mixed")
...
output_cls_file <- "./resources/processed_data/gsea/gsea_mixed_celltype.cls"
