...
# load result files that contains gene names, padj, L2FC of DEGs with padj<0.05
...
# load result files that contains gene names, padj, L2FC of all genes used in each analysis
...
# list of Tables containing the gene names, l2fc, padj of all genes analyzed in each analysis
...
FC_thr<-1 # L2FC threshold for DEG 
