...
cont_bronch<-file.path("./reports/local_only/deg_bal_nasal~cell2025-01-21")
...
output_dir <- "./reports/figures/deg/volcano_plot/nasal"
...
## GO analysis  
###########################
go_deg_folder<-file.path("./reports/local_only/deg_bal_nasal~cell2025-01-21/GO_output")
