...
# determine which phenotypic thresholds to use by assessing the proportion of samples below the potential thresholds
...
} # function that helps to determine the thresholds. assesses what proportion of the data is below the threshold in question
...
phen<-phen%>%mutate(isBalEosCtNa=is.na(BAL_eos_ct),
              ...
              isbldEosct300=!blood_eos<300, # 300 for AEC since that is the cutoff for immunotherapy
